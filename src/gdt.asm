...
gdt_code: ;code segments descriptor
  ;base=0x0, limit=0xfffff
  ;1st flags: (present)1 (privalage)00 (descriptor type)1 -> 1001b
...
gdt_data:   ;the data segments descriptor
...
gdt_end:    ;for calculating the size of the gdt
